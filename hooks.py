...
app_email = "mohankrishna3779@gmail.com"
app_license = "mit"
...
doc_events = {
    "Tickets": {
        "on_save": "helpdesk.helpdesk_ticketing_system.doctype.tickets.tickets.update_validate"  # Triggered when a ticket is updated
    }
}
...
scheduler_events = {
    "cron": {
        "0 */12 * * *": [
            "helpdesk_ticketing_system.send_ticket_report.send_ticket_report"
        ]
    }
}
